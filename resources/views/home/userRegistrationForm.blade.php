...
<div class="modal" id="userRegistrationModal" tabindex="-1" aria-labelledby="userRegistrationModalLabel"
    aria-hidden="true">
                ...
                <form method="POST" action="{{ route('user.registration.submit') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="user_contact_number" name="user_contact_number"
                                required>
                        </div>
                    </div>
